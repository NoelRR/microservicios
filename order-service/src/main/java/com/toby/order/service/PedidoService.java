package com.toby.order.service;

import com.toby.order.client.MenuClient;
import com.toby.order.client.PlatoDTO;
import com.toby.order.dto.ItemRequest;
import com.toby.order.dto.PedidoRequest;
import com.toby.order.exception.PedidoInvalidoException;
import com.toby.order.exception.RecursoNoEncontradoException;
import com.toby.order.messaging.OrderEvent;
import com.toby.order.messaging.OrderPublisher;
import com.toby.order.model.EstadoPedido;
import com.toby.order.model.ItemPedido;
import com.toby.order.model.Pedido;
import com.toby.order.repository.PedidoRepository;
